...
export const Ps5Setup = () => {
  const scriptLabels = windowsScriptDocs?.ps7 || [];
  const scriptConfigs = windowsData?.ps7 || [];
  ...
  return (
    <div className="ps-3 pe-3">
      ...
      <p className="text-muted">
        ...
        code, configure the environment, and launch your Spring Boot server in a
        new powershell {selectedScript.powershellVersion} window.
      </p>
    </div>
  );
};
