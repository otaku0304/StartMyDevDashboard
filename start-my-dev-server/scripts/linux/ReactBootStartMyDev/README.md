# ReactBootStartMyDev (Linux Edition)

ReactBootStartMyDev is a lightweight, script-driven solution to instantly launch your Fullstack (React + Spring Boot) projects **without opening an IDE**.
...
- Launches Backend (Spring Boot) and Frontend (React) in separate new terminal windows
...
Before running, open `ReactBootStartMyDev.sh` and set the following variables:
